          ...
          <div className="projects m-4">
            <div className="project1 shadow-sm">
              ...
              <div className="text-left p-3">
                ...
                <h6 className="mt-2">Rhino Splits is my Front-End capstopne
            ...
            <div className="project2 shadow-sm">
              ...
              <div className="text-left p-3">
                ...
                <h6 className="mt-2"> A user friendly chat application that
            ...
            <div className="project3 shadow-sm">
              ...
              <div className="text-left p-3">
                ...
                <h6 className="mt-2"> Nutshell is our group project that incorporates the following features:</h6>
                <ul>
                  <li>Google authentication</li>
            ...
            <div className="project4 shadow-sm">
              ...
              <div className="text-left p-3">
                ...
                <h6 className="mt-2">Rhino Splits is my UX/UI case study
                   projects at NSS. This is online payment
                     simulator that incorporates the following features:</h6>
                <ul>
