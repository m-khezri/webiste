...
import video from '../../image/affcars/video.mp4';
    ...
    return (
      <div>
        <div className='videoContainer'>
          <video autoPlay loop muted id='affVideo'>
            <source src={video} type='video/mp4'></source>
          </video>
          <div className='title'>
            <Fade bottom delay='2000'> <h1 className='title-affcar'>Affcars</h1></Fade>
            <Fade bottom delay='3000'><h3 className='title-desc'> Online Car Affiliate Program</h3></Fade>
            <Fade bottom delay='4000'><h6 className='title-note'>(Case Study)</h6></Fade>
          </div>
          <div className="navLink row">
            <Link className="col-6 nav-link text-light" to="/"><i className="fas fa-home"></i>Home</Link>
            <Link className="col-6 nav-link text-light" to="/projects"><i className="fas fa-project-diagram"></i>Projects</Link>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <Fade bottom>
            <section id="section13" className="wireframing row text-light wireframing text-left p-2">
              ...
              <div className="col-md-6">
                <h2 className='sec-title my-5'>Home Page</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Search Result </h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title my-5'>Product Page </h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title my-5'>Buyer Login</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Deal Details</h2>
                <ul>
                  <li>
      ...
      They can read and write a review for the dealer too. They also have access to this dealer inventory.Eventually, by clicking on the 'Make it Yours' button, they canget the discount voucher and book this car.
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Recieve the Voucher</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Buyer C-Panel</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Save Cars</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Upload Documents</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Create Alerts</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Profile</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Payment Setup</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Dealer Login</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title '>Active Inventory</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Sold Inventory</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Reports and Stats</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Update Profile</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Add New car Step 1</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Add New car Step 2</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Add New car Step 3</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col-md-6">
                <h2 className='sec-title  my-5'>Add New car Step 4</h2>
                <ul>
                  <li>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col">
                <h2 className='sec-titlemy-5'>Color Theme</h2>
                <div className='row px-5'>
          ...
          <Fade bottom>
            <section className="wireframing row text-light wireframing text-left p-2">
              <div className="col">
                <h2 className='sec-title  my-5'>High Fidelity Mockup</h2>
                <p>
